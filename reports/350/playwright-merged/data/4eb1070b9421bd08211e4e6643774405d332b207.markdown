...
Call log:
  - waiting for locator('input[placeholder=\'Search Test Assignments\']')
...
- generic [active]:
  - dialog "Administration Overview for Oral Vocabulary–Synonyms" [ref=e2]:
    - banner [ref=e3]:
      ...
      - 'button "N4319A69522, Edna Age: 5y Grade: Kindergarten" [ref=e9] [cursor=pointer]':
        - img [ref=e10]
        - generic [ref=e13]:
          - generic [ref=e14]: N4319A69522, Edna
  ...
  - dialog [ref=e126]:
    - banner [ref=e127]:
      ...
      - generic [ref=e130]:
        - generic [ref=e131]:
          - 'button "N4319A69522, Edna Age: 5y Grade: Kindergarten" [ref=e132] [cursor=pointer]':
            - img [ref=e133]
            - generic [ref=e136]:
              - generic [ref=e137]: N4319A69522, Edna
  ...
  - dialog [ref=e711]:
    - generic [ref=e712]:
      - button "Close Review" [ref=e714] [cursor=pointer]: ✕
      - generic [ref=e716]:
        - heading "Test Session Notes" [level=4] [ref=e717]
        - textbox "Test session notes input field" [ref=e718]:
          - /placeholder: Write Something...
      - generic [ref=e719]:
        - generic [ref=e720]:
          - 'tab "Review: Observations" [ref=e721] [cursor=pointer]': "1"
          - 'tab "Review: Notes" [selected] [ref=e722] [cursor=pointer]': "2"
        - button "Submit Test Assignment" [disabled] [ref=e724] [cursor=pointer]
```
...
```ts
  1810 |   }
  1811 | 
  1812 |   async clickFollowingRowElipsisButton(rowIndex: number) {
  1813 |     await this.elipsisButton.nth(rowIndex).click();
  1814 |   }
  1815 | 
  1816 |   async performDeleteAction() {
  1817 |     await this.deleteButton.click();
  1818 |     await this.waitForDialog();
  1819 |     await this.areYouSureYesButton.click();
  1820 |     await this.page.waitForLoadState("domcontentloaded");
  1821 |   }
  1822 | 
  1823 |   async performProceedToDelete(bool: boolean) {
  1824 |     await this.deleteButton.click();
  1825 |     await this.waitForDialog();
  1826 |     await this.verifyDeleteTestAssignmentPopUpContents();
  1827 |     if (bool) {
  1828 |     await this.proceedToDeleteButton.click();
  1829 |     await this.areYouSureYesButton.click();
  1830 |     } else {
  1831 |     await this.cancelButton.click();
  1832 |     }
  1833 |     await this.page.waitForLoadState("domcontentloaded");
  1834 |   }
  1835 | 
  1836 |   async verifyDeleteTestAssignmentPopUpContents() {
  1837 |     await this.waitForDialog();
  1838 | 
  1839 |     await expect.soft(
  1840 |       this.page.locator("//h1[text()='Delete Test Assignment']"),
  1841 |       'Delete Test Assignment heading should be visible'
  1842 |     ).toBeVisible();
  1843 | 
  1844 |     await expect.soft(
  1845 |       this.page.locator("//p[text()='Using \"Delete\" will ']"),
  1846 |       'Warning message first part should be visible'
  1847 |     ).toBeVisible();
  1848 | 
  1849 |     await expect.soft(
  1850 |       this.page.locator("//b[text()='permanently remove']"),
  1851 |       'Permanently remove bold text should be visible'
  1852 |     ).toBeVisible();
  1853 | 
  1854 |     await expect.soft(
  1855 |       this.page.locator("//p[text()=' all data associated with this test assignment. Once deleted, this data cannot be recovered.']"),
  1856 |       'Warning message second part should be visible'
  1857 |     ).toBeVisible();
  1858 |   }
  1859 | 
  1860 |   async waitForDialog() {
  1861 |     await this.page.locator("div[role='alertdialog']").waitFor({ state: "visible", timeout: 30000 });
  1862 |   }
  1863 | 
  1864 |   async verifySearchTestAssignmentFunctionalityForTestSet(testSetName: string) {
  1865 |     await this.searchTestAssignments(testSetName);
  1866 |     // await this.searchTestAssignmentsInput.fill(testSetName);
  1867 |     // await this.page.waitForLoadState("domcontentloaded");
  1868 |     // await this.page.waitForTimeout(3000);
  1869 |     const testSetNames = await this.page
  1870 |       .locator(
  1871 |         "div[class*='TestAssignmentModule'] tbody > tr td:nth-child(2) button span",
  1872 |       )
  1873 |       .allTextContents();
  1874 | 
  1875 |     for (const actualTestSetName of testSetNames) {
  1876 |       expect.soft(
  1877 |         actualTestSetName,
  1878 |         "Test set name not matching the search criteria",
  1879 |       ).toContain(testSetName);
  1880 |     }
  1881 |   }
  1882 | 
  1883 |   async verifySearchTestAssignmentFunctionalityForStatus(status: string) {
  1884 |     await this.searchTestAssignments(status);
  1885 |     // await this.searchTestAssignmentsInput.fill(status);
  1886 |     // await this.page.waitForLoadState("domcontentloaded");
  1887 |     // await this.page.waitForTimeout(3000);
  1888 |     await this.verifyVisibleStatusesInTable([status]);
  1889 |   }
  1890 | 
  1891 |   async verifyCreateNewTestAssignmentFromDashboard() {
  1892 |     await this.createTestAssignment.click();
  1893 |   }
  1894 | 
  1895 |   async verifyEditAssignmentsIconVisibilityBasedOnStatus(status: string, isVisible: boolean) {
  1896 |     await this.searchTestAssignments(status);
  1897 |     // await this.searchTestAssignmentsInput.fill(status);
  1898 |     // await this.page.waitForLoadState("domcontentloaded");
  1899 |     // await this.page.waitForTimeout(3000);
  1900 |     if (isVisible) {
  1901 |       expect.soft(await this.getNumberOfRowsInMyTestAssignments(), "Number of rows not matching with edit icon").toEqual(await this.getNumberOfEditAssignmentIcons());
  1902 |     } else {
  1903 |       expect.soft(await this.getNumberOfEditAssignmentIcons(),
  1904 |         "Edit assignment icons should not be visible",
  1905 |       ).toEqual(0);
  1906 |     }
  1907 |   }
  1908 | 
  1909 |   async searchTestAssignments(searchText: string) {
> 1910 |     await this.searchTestAssignmentsInput.fill(searchText);
       |                                           ^ TimeoutError: locator.fill: Timeout 60000ms exceeded.
  1911 |     await this.page.waitForLoadState("domcontentloaded");
